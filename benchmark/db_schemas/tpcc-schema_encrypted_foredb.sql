DROP EXTENSION edb CASCADE;
CREATE EXTENSION edb;
...
CREATE TABLE order_line (
  ...
  ol_number edb_int4 NOT NULL,
  ol_i_id int NOT NULL,
  ol_delivery_d timestamp NULL DEFAULT NULL,
  ol_amount edb_float4 NOT NULL,
  ol_supply_w_id int NOT NULL,
  ol_quantity edb_float4 NOT NULL,
...
CREATE TABLE stock (
  s_w_id int NOT NULL,
  s_i_id int NOT NULL,
  s_quantity edb_float4 NOT NULL,
  s_ytd edb_float4 NOT NULL,
  s_order_cnt edb_int4 NOT NULL,
  s_remote_cnt edb_int4 NOT NULL,
...
CREATE TABLE oorder (
  ...
  o_ol_cnt edb_float4 NOT NULL,
  o_all_local edb_float4 NOT NULL,
...
CREATE TABLE customer (
  ...
  c_d_id int NOT NULL,
  c_id int NOT NULL,
  c_discount edb_float4 NOT NULL,
  c_credit char(2) NOT NULL,
  c_last varchar(16) NOT NULL,
  c_first varchar(16) NOT NULL,
  c_credit_lim edb_float4 NOT NULL,
  c_balance edb_float4 NOT NULL,
  c_ytd_payment edb_float4 NOT NULL,
  c_payment_cnt edb_int4 NOT NULL,
  c_delivery_cnt edb_int4 NOT NULL,
...
CREATE TABLE district (
  d_w_id int NOT NULL,
  d_id int NOT NULL,
  d_ytd edb_float4 NOT NULL,
  d_tax edb_float4 NOT NULL,
...
CREATE TABLE warehouse (
  w_id int NOT NULL,
  w_ytd edb_float4 NOT NULL,
  w_tax edb_float4 NOT NULL,
  w_name edb_text NOT NULL,
